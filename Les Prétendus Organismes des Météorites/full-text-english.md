...
The structure stands out above all in the two figures photographed under high magnification, Table 9 and Table 15. On the first, one sees columns with straight fixed contours, occasionally a little curved; a few of these columns show a series of dark dots aligned in the center. These same dots can be seen on a few columns of the fifteenth table, only this selfsame figure simultaneously gives the explanation of the phenomenon, which, according to Mr. Hahn, provides the proof for the existence of an axial channel in the center of the columns.
